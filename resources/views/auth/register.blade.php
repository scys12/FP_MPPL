    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header bg-secondary text-white shadow-sm">
                    <h3 class="font-weight-bold">{{ __('Daftar Sebagai Murid') }}</h3>
                </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <div class="" style="display: flex;align-items: baseline;">
                                        <button type="submit" class="btn btn-lg btn-secondary text-white font-weight-bold mr-3">{{('Daftar Sebagai Murid') }}
                                        </button>
                                        <div>
                                            <p>
                                                <strong>atau <a href="{{route('teacher.register')}}">Daftar Sebagai Pengajar</a></strong>
                                            </p>                                    
                                        </div>
                                    </div>                            
                                </div>
