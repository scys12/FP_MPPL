...
<div class="bg-light pt-6 pb-3">
  <div class="container mb-3 mt-3">
    <div class="row">
            ...
            <div style="display: flex;flex-direction:row;justify-content: space-between; align-items:baseline">
              ...
              @if ($comment->user_ids == Auth::user()->id)
                <div class="icon d-flex" style="justify-content: center;align-items:end">
                  ...
                  <a href="{{route('soal_materi.comment.update', ['id' => $id, 'question_id' => $question->id, 'comment_id' => $comment->id])}}">
      ...
      <div class="col-md-12 mt-3">
        <div class="card-body border-bottom">
          <form action="{{route('soal_materi.comment.insert', ['id' => $id, 'question_id' => $question->id])}}" method="post">
            @csrf
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-footer">
              <form action="{{route('soal_materi.comment.delete', ['id' => $id, 'question_id' => $question->id])}}" method="post" id="modal-form">
                  @csrf
                  @method('DELETE')
