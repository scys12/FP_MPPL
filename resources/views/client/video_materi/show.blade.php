        ...
        <div class="col-md-12">      
          ...
          <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="diskusi" role="tabpanel" aria-labelledby="diskusi">
                    ...
                    <div class="card" style="width: 100%">
                      <div class="card-body">
                        <div style="display: flex;flex-direction:row;justify-content: space-between">
                          <a class="mb-1 font-weight-bold" href="{{route('video_materi.question.show', ['id' => $video_materi->id, 'question_id' => $question->id])}}">{{$question->question}}</a>
                          @if ($question->user_ids == Auth::user()->id)
                            <div class="icon d-flex" style="justify-content: center;align-items:end">
                              ...
                              <a href="{{route('video_materi.question.update', ['id' => $video_materi->id, 'question_id' => $question->id])}}">
              ...
              @endforeach
              <form action="{{route('video_materi.question.insert', ['id' => $video_materi->id])}}" method="post">
                @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('video_materi.question.delete', ['id' => $video_materi->id])}}" method="post" id="modal-form">
                    @csrf
                    @method('DELETE')
