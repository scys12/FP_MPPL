<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light scrolled awake" id="ftco-navbar">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            @else
                <li class="nav-item"><a href="{{route('dashboard')}}" class="nav-link"><span>Dashboard</span></a></li>
                <li class="nav-item"><a href="{{route('belajar_mandiri')}}" class="nav-link"><span>Belajar Mandirit</span></a></li>
                <li class="nav-item"><a href="{{route('private')}}" class="nav-link"><span>Kelas Private</span></a></li>
                <li class="nav-item"><a href="{{route('freemalangga')}}" class="nav-link"><span>Freemalangga</span></a></li>
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('packet.history') }}">{{ __('Histori Pembayaran') }}</a>
