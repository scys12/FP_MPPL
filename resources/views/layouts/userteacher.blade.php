<nav class="navbar navbar-expand-lg navbar-light py-2 shadow-sm"   style="background-color:white">
    <div class="container">
                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('teacher.materi.index') }}">{{ __('Materi Saya') }}</a>
