<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light scrolled awake" id="ftco-navbar">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            @else
                <li class="nav-item"><a href="{{ route('teacher.dashboard') }}" class="nav-link"><span>Dashboard</span></a></li>
                <li class="nav-item"><a href="{{route('freemalangga')}}" class="nav-link"><span>Freemalangga</span></a></li>

                <li class="nav-item"><a href="{{route('teacher.class.index')}}" class="nav-link"><span>Kelas Private Saya</span></a></li>
                <li class="nav-item"><a href="{{route('teacher.video_materi.index')}}" class="nav-link"><span>Video Materi Saya</span></a></li>
                <li class="nav-item"><a href="{{route('teacher.materi.index')}}" class="nav-link"><span>Materi Saya</span></a></li>                
