            ...
            <div style="display: flex;flex-direction:row;justify-content: space-between; align-items:baseline">
              ...
              @if ($comment->user_ids == Auth::user()->id)
                <div class="icon d-flex" style="justify-content: center;align-items:end">
                  ...
                  <a href="{{route('teacher.soal_materi.comment.update', ['id' => $id, 'question_id' => $question->id, 'comment_id' => $comment->id])}}">
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-footer">
              <form action="{{route('teacher.soal_materi.comment.delete', ['id' => $id, 'question_id' => $question->id])}}" method="post" id="modal-form">
                  @csrf
                  @method('DELETE')
